...
function getRajaOngkirProvinceId(localProvinceId: string, provincesList: { id: number; name: string }[]): string {
  ...
  const nameToRajaOngkirId: Record<string, string> = {
    ...
    'kalimantantimur': '7',
    'kepulauanriau': '8',
    'nanggroeacehdarussalamnad': '9',
    'nanggroeacehdarussalam': '9',
    'aceh': '9',
    'dkijakarta': '10',
    'jakarta': '10',
    'banten': '11',
    ...
    'yogyakarta': '19',
    'sulawesitenggara': '20',
    'nusatenggaratimurntt': '21',
    'nusatenggaratimur': '21',
    'sulawesiutara': '22',
    'sumaterabarat': '23',
    'bangkabelitung': '24',
    'riau': '25',
...
async function fetchCitiesByProvinceId(supabaseProvinceId: string, provincesList: { id: number; name: string }[]) {
  try {
    ...
    if (!response.ok) {
      console.error(`Error from RajaOngkir cities API route: ${response.status}`, await response.text());
      return [];
    }
    ...
    console.error('RajaOngkir API returned success=false or no data:', result);
    return [];
  } catch (error) {
